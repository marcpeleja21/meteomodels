...
export const MODELS: WeatherModel[] = [
  ...
  { key:'icon_eu',   name:'ICON EU',     fullName:'ICON Europa (7 km)',            apiId:'icon_eu',                     org:'DWD · Alemanya',  color:'#ffab91', flag:'🇩🇪', avail:true,  global:false, coverage:'Europa',                  resKm:7,   terrainSensitive:false },
  { key:'meteoblue', name:'MeteoBlue',   fullName:'NMM Nonhydrostatic Meso-Scale', apiId:null,                          org:'MeteoBlue · CH',  color:'#a5d6a7', flag:'🇨🇭', avail:false, mb:true,      resKm:7,   terrainSensitive:false },
  { key:'arome_hd',  name:'AROME HD',    fullName:'AROME France HD (1.5 km)',      apiId:'meteofrance_arome_france_hd', org:'Météo-France',    color:'#80deea', flag:'🇫🇷', avail:true,  global:false, coverage:'França', maxDays:2,         resKm:1.5, terrainSensitive:false },
  { key:'arome',     name:'AROME 2.5km', fullName:'AROME France (2.5 km)',         apiId:'meteofrance_arome_france',    org:'Météo-France',    color:'#80cbc4', flag:'🇫🇷', avail:true,  global:false, coverage:'França', maxDays:2,         resKm:2.5, terrainSensitive:false },
  { key:'arpege',    name:'ARPEGE EU',   fullName:'ARPEGE Europa · proxy ALADIN',  apiId:'meteofrance_arpege_europe',   org:'Météo-France',    color:'#ffcc80', flag:'🇫🇷', avail:true,  global:false, coverage:'Europa',                  resKm:10,  terrainSensitive:true  },
  { key:'icon_d2',       name:'ICON D2',         fullName:'ICON Deutschland 2 (2.2 km)',          apiId:'icon_d2',                     org:'DWD · Alemanya',      color:'#f48fb1', flag:'🇩🇪', avail:true, global:false, coverage:'Europa Central',        maxDays:2, resKm:2.2, terrainSensitive:false },
  { key:'geosphere',    name:'ALADIN-AROME',    fullName:'AROME Àustria / ALADIN (2.5 km)',      apiId:'geosphere_arome_austria',     org:'GeoSphere · Àustria',  color:'#9fa8da', flag:'🇦🇹', avail:true, global:false, coverage:'Alps / Europa Central', maxDays:2, resKm:2.5, terrainSensitive:false },
  { key:'knmi_harmonie',name:'HARMONIE EU',     fullName:'HARMONIE-AROME Europa (2.5 km)',       apiId:'knmi_harmonie_arome_europe',  org:'KNMI · Països Baixos', color:'#b39ddb', flag:'🇳🇱', avail:true, global:false, coverage:'Europa',                maxDays:2, resKm:2.5, terrainSensitive:false },
  { key:'dmi_harmonie', name:'HARMONIE DMI',    fullName:'HARMONIE-AROME Europa / DMI (2.5 km)',apiId:'dmi_harmonie_arome_europe',   org:'DMI · Dinamarca',      color:'#4dd0e1', flag:'🇩🇰', avail:true, global:false, coverage:'Europa',                maxDays:2, resKm:2.5, terrainSensitive:false },
  { key:'ukmo',         name:'UKMO',            fullName:'UK Met Office Global (10 km)',         apiId:'ukmo_seamless',               org:'Met Office · UK',      color:'#ffb74d', flag:'🇬🇧', avail:true, global:true,  resKm:10,  terrainSensitive:true  },
  { key:'gem',          name:'GEM',             fullName:'Global Environmental Multiscale (15 km)',apiId:'gem_seamless',              org:'ECCC · Canadà',        color:'#c5e1a5', flag:'🇨🇦', avail:true, global:true,  resKm:15,  terrainSensitive:true  },
]
